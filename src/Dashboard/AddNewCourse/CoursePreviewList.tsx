...
import AccordionPreview from "@/components/shared/AccordionPreview";
...
const CoursePreviewList = ({ description, questions, price, timeDuration, title, totalMarks, totalQuestions }: CourseType) => {
    ...
    return (
        <div className="nbg-secondary nw-full np-4">
                    ...
                    <motion.div
                        ...
                        <div className="nflex nflex-wrap njustify-between ngap-3">
                            ...
                            <span className="nbg-secondary nrounded-full npx-2 nflex npy-1 nitems-center njustify-center ntext-xs">
                                <InputControl className="nw-[50px]  !ntext-xs !npx-0" value={timeDuration.hh} readonly />
                                <InputControl className="nw-[50px]" value={timeDuration.mm} readonly />
                                <InputControl className="nw-[50px]" value={timeDuration.ss} readonly />
                            </span>
                        ...
                        <Each of={questions} render={(question, index) => <div>
                            ...
                            <Each of={question.options} render={(op) => <InputControl className={`${op == question.correctAnswer ? 'nbg-brand' : ''}`} value={op} readOnly />} />
